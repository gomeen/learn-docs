...
- 集合框架
- Java 8 时间 API（详见 [10-time-api](./11-time-api.md)）
- 08-collections.md、11-time-api.md
...
| `hutool-crypto` | 安全加密（对称/非对称原理见 [对称加密](../../_common/06-encryption/01-symmetric.md) / [非对称加密](../../_common/06-encryption/02-asymmetric.md)） |
