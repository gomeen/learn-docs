...
### 3.1 ProductSpuController

**文件位置**：`/Users/xu/code/github/ruoyi-vue-pro/yudao-module-mall/yudao-module-product/src/main/java/cn/iocoder/yudao/module/product/controller/admin/spu/ProductSpuController.java`
...
public class ProductSpuController {
    ...
    public CommonResult<Long> createSpu(@Valid @RequestBody ProductSpuSaveReqVO createReqVO) {
...
**文件位置**：`/Users/xu/code/github/ruoyi-vue-pro/yudao-module-mall/yudao-module-product/src/main/java/cn/iocoder/yudao/module/product/controller/admin/property/`

商品属性分两类：
- **销售属性**（规格）：如"颜色、容量"，用于 SKU 区分
- **非销售属性**（参数）：如"屏幕尺寸、CPU"，仅展示
...
打开 `ProductSpuDO.java` 和 `ProductSkuDO.java`，列出所有字段并比较差异。

### 练习 2：进阶

阅读 `ProductSpuServiceImpl.java`，理解创建 SPU 时如何校验 SKU 规格不重复。

### 练习 3：挑战（选做）

设计"商品多规格价格"：不同 SKU 有不同价格（如"双 11 限时特价"），需要做哪些扩展？

## 6. 参考资料

- `/Users/xu/code/github/ruoyi-vue-pro/yudao-module-mall/yudao-module-product/src/main/java/cn/iocoder/yudao/module/product/controller/admin/spu/ProductSpuController.java`
