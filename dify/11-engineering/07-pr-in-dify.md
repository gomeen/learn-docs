...
- GitHub Issue、Fork、Branch 与 Pull Request 基础（详见 [Git 工作流](../../_common/15-git/02-git-workflow.md)）
- Markdown 注释、表格和任务清单语法
- 了解 Lint、Type Check、测试和文档更新
- 建议先学习：[提 PR 的最佳实践](../../_common/20-engineering/08-pr-best-practices.md)
- 建议配合：[Reviewer 检查清单](../../_common/20-engineering/07-review-checklist.md)
...
**文件位置**：`/Users/xu/code/github/dify/.github/PULL_REQUEST_TEMPLATE.md`（以仓库实际为准）
...
- Summary 需写清变更、动机与依赖，并按注释要求披露自动化 Agent 来源
- Screenshots 用 Before/After 表格承载 UI 证据；无 UI 变化时也应写明原因
- Checklist 是作者声明：文档、前置讨论、测试、原子性和工具检查均应有证据
