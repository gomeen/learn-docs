...
## 📚 前置知识
- Git 分支、提交、Fork 和 Pull Request 基础（详见 [Git 工作流](../../_common/15-git/02-git-workflow.md)、[Conventional Commits](../../_common/15-git/03-conventional-commits.md)）
- Markdown 标题、列表、链接与代码块语法
- 基本的软件测试和持续集成概念（详见 [CI/CD 概念](../../_common/11-cicd/01-concepts.md)）
- 建议先阅读 `../../_common/20-engineering/08-pr-best-practices.md`
- 建议结合 `../../_common/20-engineering/12-issue-management.md` 理解 Issue 与 PR 的衔接
...
- 先给出可执行入口：good first issue、插件仓库、官方插件仓库
- 欢迎语气之外仍指向具体仓库路径，避免「不知道从哪下手」
- 与全文的 License / CoC 声明一起构成贡献者与维护者的共同边界
- 指南会演进，但具体命令仍应以仓库当前文档与 CI 为准
