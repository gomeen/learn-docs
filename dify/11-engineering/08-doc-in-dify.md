...
- 前后端项目的目录结构常识
- 建议先学习 [技术文档写作：README / ADR / Runbook](../../_common/20-engineering/09-tech-writing.md)
- 建议先学习 [API 文档：OpenAPI / Swagger](../../_common/20-engineering/10-api-doc.md)
- 建议先学习 [架构决策记录（ADR）](../../_common/20-engineering/11-adr.md)
...
- 解释 Dify 是什么以及核心能力
- 提供 Docker Compose 快速启动路径（详见 [Docker Compose](../../_common/09-containerization/04-compose.md)）
- 导航到云服务、自托管和完整产品文档
- 介绍功能、部署选项与社区入口
- 提供多语言 README 导航
...
```python
from dataclasses import dataclass  # 详见 [dataclass](../01-fundamentals/26-dataclasses.md)
