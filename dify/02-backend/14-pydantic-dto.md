...
- [Pydantic 基础](./12-pydantic-basics.md)
- [dify Controller 设计](./10-flask-in-dify.md)
- DDD 基础（聚合根、实体；详见 [DDD 核心概念](../../_common/22-architecture/01-ddd-concepts.md)）
...
# 3. 响应（DTO；ConfigDict 详见 [Pydantic 配置](./15-pydantic-config.md)）
...
### 3.1 dify DTO 规范（API_SCHEMA_GUIDE 节选）

**文件位置**：`/Users/xu/code/github/dify/api/controllers/API_SCHEMA_GUIDE.md`（或 `api/AGENTS.md` 同类约定）
