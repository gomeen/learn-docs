...
- 命令行基础
- ../../dify/01-fundamentals/12-config-file-format.md
...
> 学完 [20-pydantic-settings](../../dify/01-fundamentals/18-pydantic-settings.md) 后再做：用 `pydantic-settings` 写一个 `Settings` 类，用环境变量和 `.env` 文件自动加载 dify 的所有 DB / Redis / Celery 配置。
