...
- 建议先学习 [技术文档写作：README / ADR / Runbook](09-tech-writing.md)
...
假设代码显示系统通过 Redis 投递后台任务（Redis 能力详见 [Redis 数据结构](../../_common/01-redis/01-data-structures.md)）。
...
- 将一个函数从 80 行拆成 3 个函数
- 把公共 API 认证从 Session 改为 OAuth 2.0（详见 [OAuth 2.0](../../_common/07-authentication/05-oauth2.md)）
- 统一变量名拼写
