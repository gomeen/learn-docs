...
- `01-k8s-concepts.md` ~ `05-k8s-storage.md`
...
- **Repository**：Chart 的仓库（类似 Docker Hub，镜像/仓库概念详见 [Docker 核心概念](../../_common/09-containerization/01-concepts.md)）
...
- 每个组件可独立启用/禁用（类似 docker-compose 的 profile，详见 [Docker Compose](../../_common/09-containerization/04-compose.md)）
