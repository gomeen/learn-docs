...
| 特性 | MyISAM | InnoDB |
|------|--------|--------|
| 事务支持 | ❌ 不支持 | ✅ [ACID](./16-acid.md) |
| 行级锁 | ❌ 表级锁 | ✅ 行级锁 + 间隙锁（详见 [19-locks](./19-locks.md)） |
| 外键 | ❌ | ✅ |
| [MVCC](./18-mvcc.md) | ❌ | ✅ |
| 崩溃恢复 | ❌ 容易损坏 | ✅ redo log |
| 全文索引 | ✅ 内置 | ✅（MySQL 5.6+，见 [15-fulltext-index](./15-fulltext-index.md)） |
| 地理空间 | ✅ | ✅ |
| 索引类型 | 非聚簇 | [聚簇](./12-clustered-index.md) |
